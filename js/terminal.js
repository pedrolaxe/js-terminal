...
* JS Terminal
* Version 1.0
* Pedro Laxe <pedro@phpsec.com.br>
**/
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var textReplies = function() {
    switch(textInputValueLowerCase){
      case "creator":
        clearInput();
        addTextToResults("My Creator is Pedro Laxe");
        break;
      ...
      case "git":
        clearInput();
        addTextToResults("git push origin master <br>you can check this project's repo on GitHub: <a target='_blank' href='https://github.com/pedrolaxe/js-terminal'>https://github.com/pedrolaxe/js-terminal</a>");
        break;
  ...
  var checkWord = function() {
    ...
    if (textInputValue != ""){ //checking if text was entered
      ...
      if (textInputValueLowerCase.substr(0,5) == "open ") { //if the first 5 characters = open + space
        ...
        openLinkInNewWindow('https://www.google.com.br/search?q=' + textInputValueLowerCase.substr(7));
        addTextToResults("<i>I've searched on Google for " + "<b>" + textInputValue.substr(7) + "</b>" + " it should be opened now.</i>");
      } else if (textInputValueLowerCase.substr(0,5) == "wiki "){
        openLinkInNewWindow('https://pt.wikipedia.org/w/index.php?search=' + textInputValueLowerCase.substr(5));
